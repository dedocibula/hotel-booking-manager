			...
			<s:form beanclass="cz.fi.muni.pa165.hotelbookingmanagerweb.ReservationsActionBean">
				...
				<div class="content_right_section">
					...
					<s:hidden name="to" />
						...
						<s:select id="client" name="client.id" size="10" style="width:200px; border-radius:5px;">
						...
						<s:select id="room" name="room.id" size="10" style="width:200px; border-radius:5px;">
